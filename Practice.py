...
while done==0: #цикл сделан для того, чтобы избежать перезапусков программы  для возникающих assertion error (не моя ошибка, умышленная проблема реализации алгоритма автором))
